   ...
   <div class="container" style="width:99%;margin-top:-25px;">
	...
	<div class="toolbar" style="float:left;padding-top:10px;padding-left:15px;">
		<el-form :inline="true" :model="filters" :size="size">
			...
			<el-form-item>
				<bit-button label="查询" perms="sys:dept:view" type="primary" @click="findTreeData(null)"/>
			</el-form-item>
			<el-form-item>
    ...
    <el-table :data="tableTreeDdata" stripe size="mini" style="width: 100%;"
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <bit-button label="修改" perms="sys:dept:edit" @click="handleEdit(scope.row)"/>
          <bit-button label="删除" perms="sys:dept:delete" type="danger" @click="handleDelete(scope.row)"/>
        </template>
      </el-table-column>
    </el-table>
    <!-- 新增修改界面 -->
